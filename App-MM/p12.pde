...
// TEXTOS
  ...
  textSize(28);
  text("Você deve ativar sua localização",width/2,260);
  text("para qualquer app que",width/2,300);
  text("pedir?",width/2,340);
...
// TELA DICA
  if (dicaAtual == 1) {
    ...
    fill(0); textSize(24);
    text("Sua localização pode",160,320);
    text("ser perigosa!",160,360);
  }
}
