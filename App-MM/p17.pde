...
// TEXTOS
  ...
  textSize(28);
  text("Se um site diz que você",width/2,260);
  text("ganhou um prêmio e pede",width/2,300);
  text("seus dados, você passa?",width/2,340);
...
// TELA DICA
  if (dicaAtual == 1) {
    ...
    fill(0); textSize(24);
    text("Prêmios falsos são",160,320);
    text("armadilhas de golpistas!",160,360);
  }
}
