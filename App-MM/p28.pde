...
// TEXTOS
  ...
  textSize(28);
  text("Manter seus aplicativos",width/2,260);
  text("atualizados ajuda a",width/2,300);
  text("proteger seu dispositivo?",width/2,340);
...
// TELA DICA
  if (dicaAtual == 1) {
    ...
    fill(0); textSize(24);
    text("Atualizações corrigem",160,320);
    text("falhas de segurança!",160,360);
  }
}
