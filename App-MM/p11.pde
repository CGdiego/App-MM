...
// TEXTOS
  ...
  textSize(28);
  text("Você deve responder mensagens",width/2,260);
  text("ofensivas que recebe",width/2,300);
  text("na internet?",width/2,340);
...
// TELA DICA
  if (dicaAtual == 1) {
    ...
    fill(0); textSize(24);
    text("Ignorar é a melhor",160,320);
    text("resposta!",160,360);
  }
}
