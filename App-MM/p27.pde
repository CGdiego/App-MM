...
// TEXTOS
  ...
  textSize(28);
  text("Você deve dizer sua",width/2,260);
  text("idade e onde estuda",width/2,300);
  text("para estranhos online?",width/2,340);
...
// TELA DICA
  if (dicaAtual == 1) {
    ...
    fill(0); textSize(24);
    text("Dados pessoais",160,320);
    text("ficam com você!",160,360);
  }
}
