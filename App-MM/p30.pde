...
// TEXTOS
  ...
  textSize(28);
  text("Você deve abrir arquivos",width/2,260);
  text("enviados por e-mail de",width/2,300);
  text("remetentes desconhecidos?",width/2,340);
