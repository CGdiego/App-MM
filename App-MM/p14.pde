...
// TEXTOS
  ...
  textSize(28);
  text("É seguro digitar senhas",width/2,260);
  text("em redes Wi-Fi",width/2,300);
  text("públicas?",width/2,340);
...
// TELA DICA
  if (dicaAtual == 1) {
    ...
    fill(0); textSize(24);
    text("Wi-Fi público pode",160,320);
    text("ser espionado!",160,360);
  }
}
